...
$intens_pluviotb = $intens_pluviotb_min*60
If ( $intens_pluviotb -lt 0.1 ) {
    $intens_pluviotb = 0.0
}
...
Write-Host " "
#Write-Host "DIS: rainacc=$acc_pluvio - last_acc=$last_acc_pluvio - last_acc_archive=$last_acc_pluvio_archive - inst_acc_pluvio=$inst_acc_pluvio"
#Write-Host "-TB: rainacc=$acc_pluviotb - last_acc=$last_acc_pluviotb - last_acc_archive=$last_acc_pluviotb_archive - inst_acc_pluvio=$inst_acc_pluviotb"
